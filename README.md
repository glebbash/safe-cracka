...
A safe-dial cracking game for web.

This project was generated by AI.

![Safe Cracka game](assets/safe-cracka.png)
...
Use `npx tsc app.js --noEmit --allowJs --lib esnext,dom` for typechecking.

Use `npx serve .` to start a local development server.
